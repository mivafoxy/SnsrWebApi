...
- **API.Device**
	- **GetApiDevice**: GET `/api/device`
	- **GetApiDeviceDeviceIdandobjectIdandstartDateandendDate**: GET `/api/device/deviceid}&objectid}&startdate}&enddate}`
	- **PostApiDevice**: POST `/api/device`
- **API.DeviceDescription**
	- **GetApiDeviceDescriptions**: GET `/api/devicedescriptions`
# SnsrWebApi
